...
This is an experiment that reworks the Nighttime Fatigue request to add Time Limit 1 when you shuffle your draw pile mid-turn, rather than adding a Long Night card to the hand at the start of combat.

Time Limit is *only* applied when you shuffle the discard pile into the draw pile mid-turn. If you shuffle during the draw step or after your turn ends, nothing happens.
...
This is a very early test, there may be edge cases I haven't thought of. This mod was made to prototype how this tweak would affect the game. Gameplay feedback is very much welcome and requested.

Thumbnail source: https://x.com/ttzlwrm/status/1981431833750622277
